    ...
    >
      <body className="min-h-full flex flex-col overflow-x-hidden bg-cream-200 text-olive-900 dark:bg-olive-900 dark:text-cream-100">
        <header className="sticky top-0 z-10 border-b border-cream-300 bg-cream-50/90 backdrop-blur-md">
          <nav className="mx-auto flex max-w-3xl items-center gap-2 px-4 py-3 text-sm sm:gap-4">
            <Link href="/" className="flex shrink-0 items-center gap-1.5 font-semibold tracking-tight text-olive-900">
            ...
            <span className="hidden text-cream-400 sm:inline">|</span>
            <Link href="/scan" className="shrink-0 text-cream-700 hover:text-olive-900 hover:underline">Scan</Link>
            <Link href="/station/1" className="shrink-0 text-cream-700 hover:text-olive-900 hover:underline">Stations</Link>
            <span className="ml-auto flex min-w-0 shrink items-center gap-2 sm:gap-3">
              <AuthNav />
              <span className="hidden shrink-0 rounded-full bg-forest-100 px-3 py-0.5 text-xs text-forest-800 sm:inline-block">
                Solana devnet
              </span>
            </span>
          </nav>
